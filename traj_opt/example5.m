...
t.run.hours = 1;       % simulation run hours
...
% optimization params
op.n       = 180;                  % num. of time intervals, guideline is 1 per 20 sec
...
op.fevals  = 50*op.n;                % maximum number of function evaluations - 1000*n is a good baseline
